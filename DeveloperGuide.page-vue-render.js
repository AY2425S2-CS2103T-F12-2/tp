...
with(this){return _c('h2',{attrs:{"id":"implementation-2"}},[_c('strong',[_v("Implementation")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implementation-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Creating a contact")]),_v(" "),_c('li',[_v("Creating a wedding")]),_v(" "),_c('li',[_v("Tagging the contact to the wedding")]),_v(" "),_c('li',[_v("Untagging the contact from the wedding")]),_v(" "),_c('li',[_v("Deleting the wedding")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The user begins by creating a new contact using the addContact command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johndoe@example.com a/123 Some Street r/Manager")]),_v("\nThis command creates a contact with the specified name, phone number, email, address, and role.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The field(s) is/are empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. An error message is shown.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("2a. All the fields in the input match an existing wedding event in the list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. An error message is shown.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User inputs the command to list wedding events sorted from closest to latest date")])]),_v(" "),_c('li',[_c('p',[_v("EasyWeds shows the list of wedding events")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC17 - Confirm Action")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User attempts an action that requires confirmation (e.g., adding a duplicate contact)")])]),_v(" "),_c('li',[_c('p',[_v("EasyWeds shows a warning message requiring confirmation")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the action")])]),_v(" "),_c('li',[_c('p',[_v("EasyWeds performs the requested action")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. User does not confirm the action.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. User inputs a different command.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC18 - Clear Contact Book")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 14:00:12 GMT+8]")])])])}
}];
