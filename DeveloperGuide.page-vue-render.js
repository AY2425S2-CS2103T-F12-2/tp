...
with(this){return _c('h2',{attrs:{"id":"user-workflow-implementation"}},[_c('strong',[_v("User Workflow Implementation")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#user-workflow-implementation","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Creating a contact")]),_v(" "),_c('li',[_v("Creating a wedding")]),_v(" "),_c('li',[_v("Tagging the contact to the wedding")]),_v(" "),_c('li',[_v("Adding a task to the wedding")]),_v(" "),_c('li',[_v("Deleting a task from the wedding")]),_v(" "),_c('li',[_v("Untagging the contact from the wedding")]),_v(" "),_c('li',[_v("Deleting the wedding")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"1-creating-a-contact"}},[_v("1. Creating a contact"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#1-creating-a-contact","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The user begins by creating a new contact using the add command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johndoe@example.com a/123 Some Street r/Manager")]),_v("\nThis command creates a contact with the specified name, phone number, email, address, and role.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is a sequence diagram that shows the steps involved when a user creates a contact.\nThis diagram illustrates how the command flows from the user through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(", is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" (with help from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommandParser")]),_v("), and then executed on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". Finally, the updated address book is saved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" and a success message is returned to the user.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"2-creating-a-wedding"}},[_v("2. Creating a wedding"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#2-creating-a-wedding","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The user can create a wedding using the addWedding command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addWedding n/John Doe d/2025-12-25 l/Some Venue")]),_v("\nThis command creates a wedding with the specified name, date, and location.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is a sequence diagram that shows the steps involved when a user creates a wedding.\nThis diagram illustrates how the command flows from the user through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(", is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" (with help from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddWeddingCommandParser")]),_v("), and then executed on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". Finally, the updated address book is saved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" and a success message is returned to the user.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The user can tag a contact to a wedding using the tag command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tag 1 W1")]),_v("\nThis command tags the contact with the specified name to the wedding with the specified wedding ID.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is a sequence diagram that shows the steps involved when a user tags a contact to a wedding.\nThis diagram illustrates how the command flows from the user through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(", is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" (with help from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TagCommandParser")]),_v("), and then executed on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". Finally, the updated address book is saved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" and a success message is returned to the user.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"4-adding-a-task-to-a-wedding"}},[_v("4. Adding a task to a wedding"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#4-adding-a-task-to-a-wedding","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The user can add a task to a wedding using the addTask command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addTask w/W1 desc/Book photographer")]),_v("\nThis command adds a task to the wedding with the specified wedding ID.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is a sequence diagram that shows the steps involved when a user adds a task to a wedding.\nThis diagram illustrates how the command flows from the user through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(", is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" (with help from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddTaskCommandParser")]),_v("), and then executed on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". Finally, the updated address book is saved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" and a success message is returned to the user.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"5-deleting-a-task-from-a-wedding"}},[_v("5. Deleting a task from a wedding"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#5-deleting-a-task-from-a-wedding","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The user can delete a task from a wedding using the deleteTask command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteTask w/W1 i/1")]),_v("\nThis command deletes the task with the specified index from the wedding with the specified wedding ID.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is a sequence diagram that shows the steps involved when a user deletes a task from a wedding.\nThis diagram illustrates how the command flows from the user through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(", is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" (with help from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteTaskCommandParser")]),_v("), and then executed on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". Finally, the updated address book is saved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" and a success message is returned to the user.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"6-untagging-a-contact-from-a-wedding"}},[_v("6. Untagging a contact from a wedding"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#6-untagging-a-contact-from-a-wedding","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The user can untag a contact from a wedding using the untag command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("untag 1 W1")]),_v("\nThis command untags the contact with the specified name from the wedding with the specified wedding ID.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is a sequence diagram that shows the steps involved when a user untags a contact from a wedding.\nThis diagram illustrates how the command flows from the user through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(", is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" (with help from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UntagCommandParser")]),_v("), and then executed on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". Finally, the updated address book is saved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" and a success message is returned to the user.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"7-deleting-a-wedding"}},[_v("7. Deleting a wedding"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#7-deleting-a-wedding","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The user can delete a wedding using the deleteWedding command. For example, the user might input: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteWedding W1")]),_v("\nThis command deletes the wedding with the specified wedding ID.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Below is a sequence diagram that shows the steps involved when a user deletes a wedding.\nThis diagram illustrates how the command flows from the user through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UI")]),_v(", is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" (with help from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteWeddingCommandParser")]),_v("), and then executed on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". Finally, the updated address book is saved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" and a success message is returned to the user.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EasyWeds")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("User")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Sun, 6 Apr 2025, 16:06:45 GMT+8]")])])])}
}];
